package com.definitivo.config;

import com.definitivo.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.definitivo.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.definitivo.repository.search")
